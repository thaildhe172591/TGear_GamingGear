                                    ...
                                    <tbody>
                                        <c:forEach items="${listP}" var="o">
                                            <tr>
                                                ...
                                                <td>${o.price} $</td>
                                                <td>
                                                    <a href="loadProduct?pid=${o.id}"><button type="button" class="btn btn-warning"><i class="fa-solid fa-wrench" data-toggle="tooltip" title="Edit"></i></button></a>
                                                    <a href="delete?pid=${o.id}"><button type="button" class="btn btn-danger"><i class="fa-solid fa-trash" data-toggle="tooltip" title="Delete"></i></button></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
