...
<html>
    ...
    <body>
                            ...
                            <div class="card-header py-3 row">
                                ...
                                <div class="col-sm-9 text-right">
                                    ...
                                    <form action="xuatExcelAccountControl" method="get"> 
                                        <input oninput="searchAccounts()" type="text" id="user" name="user" class="form-control mb-0" style="width:30%">
                                        <button type="submit" class="mb-0 text-center btn btn-primary">Export Excel file</button> 
                                    </form>    
                                </div>
                            </div>
                                    ...
                                    <tbody id="content">
                                        <c:forEach items="${listA}" var="o">
                                            <tr>
                                                ...
                                                <td>${o.email}</td>
                                                <td>
                                                    <a href="loadAcc?id=${o.id}"><button type="button" class="btn btn-warning"><i class="fa-solid fa-wrench" data-toggle="tooltip" title="Edit"></i></button></a>
                    ...
                    <form action="addAccount" method="post">
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group form-check">
                                ...
                                <label class="form-check-label" for="isSell">Chủ shop</label>
                            </div>
        ...
        <script type="text/javascript" src="js/script.js"></script>
        <script>
            function searchAcc(param) {
                var searchAcc = param.value;
                $.ajax({
                    url: "/LDTGear/searchAcc",
