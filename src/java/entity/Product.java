...
public class Product {
    ...
    public Product(int id, String name, String image, double price, String title, String description, String model,
            String color, String delivery, String image2, String image3, String image4, String manufacturer,int stock) {
    ...
    public String toString() {
        return "Product [id=" + id + ", name=" + name + ", image=" + image + ", price=" + price + ", title=" + title
                ...
                + ", image2=" + image2 + ", image3=" + image3 + ", image4=" + image4 + ", manufacturer=" + manufacturer + ", stock=" + stock + "]";
    }
