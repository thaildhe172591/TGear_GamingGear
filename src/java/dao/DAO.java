...
public class DAO {
    ...
    public List<Product> getNext4RazerMProduct(int amount) {
        List<Product> list = new ArrayList<>();
        String query = "select * from Product where cateID = 3 and manufacturer = 'Razer'\n"
                + "order by id desc\n"
                + "offset ? rows\n"
    ...
    public List<Product> getNext4RazerHProduct(int amount) {
        List<Product> list = new ArrayList<>();
        String query = "select * from Product where cateID = 1 and manufacturer = 'Razer'\n"
                + "order by id desc\n"
                + "offset ? rows\n"
                + "fetch next 4 rows only";
        try {
    ...
    public List<Product> getNext4LogiMProduct(int amount) {
        List<Product> list = new ArrayList<>();
        String query = "select * from Product where cateID = 3 and manufacturer = 'Logitech'\n"
                + "order by id desc\n"
                + "offset ? rows\n"
                + "fetch next 4 rows only";
        try {
    ...
    public List<Product> getNext4MonitorProduct(int amount) {
        List<Product> list = new ArrayList<>();
        String query = "select * from Product\r\n"
                + "where cateID=4\r\n"
                + "order by id desc\r\n"
    ...
    public List<Product> getNext4RazerKBProduct(int amount) {
        List<Product> list = new ArrayList<>();
        String query = "select * from Product where cateID = 2 and manufacturer = 'Razer'\n"
                + "order by id desc\n"
                + "offset ? rows\n"
                + "fetch next 4 rows only";
        try {
...
//
    ...
    public List<Product> getLastRazerMouse() {
        List<Product> list = new ArrayList<>();
        String query = "select top 6  * from Product where cateID = 3 and manufacturer = 'Razer' and price < 700 order by id desc";
        try {
            conn = new DBContext().getConnection();//mo ket noi voi sql
            ps = conn.prepareStatement(query);
            rs = ps.executeQuery();
    ...
    public List<Product> getLastRazerKB() {
        List<Product> list = new ArrayList<>();
        String query = "select top 6  * from Product where cateID = 2 and manufacturer = 'Razer' order by id desc";
        try {
            conn = new DBContext().getConnection();//mo ket noi voi sql
            ps = conn.prepareStatement(query);
            rs = ps.executeQuery();
    ...
    public List<Product> getLastRazerH() {
        List<Product> list = new ArrayList<>();
        String query = "select top 6  * from Product where cateID = 1 and manufacturer = 'Razer' order by id desc";
        try {
            conn = new DBContext().getConnection();//mo ket noi voi sql
            ps = conn.prepareStatement(query);
            rs = ps.executeQuery();
    ...
    public List<Product> getLastLogiMouse() {
        List<Product> list = new ArrayList<>();
        String query = "select top 6 * from Product where cateID = 3 and manufacturer = 'Logitech' order by id desc";
        try {
            conn = new DBContext().getConnection();//mo ket noi voi sql
            ps = conn.prepareStatement(query);
            rs = ps.executeQuery();
    ...
    public List<Product> getRazer() {
        List<Product> list = new ArrayList<>();
        String query = "select * from Product where manufacturer = 'Razer'";
        try {
            conn = new DBContext().getConnection();//mo ket noi voi sql
            ps = conn.prepareStatement(query);
            rs = ps.executeQuery();
    ...
    public List<Product> getZowie() {
        List<Product> list = new ArrayList<>();
        String query = "select * from Product where manufacturer = 'Zowie'";
        try {
            conn = new DBContext().getConnection();//mo ket noi voi sql
            ps = conn.prepareStatement(query);
            rs = ps.executeQuery();
    ...
    public List<Product> getHyperX() {
        List<Product> list = new ArrayList<>();
        String query = "select * from Product where manufacturer = 'Hyper X'";
        try {
            conn = new DBContext().getConnection();//mo ket noi voi sql
            ps = conn.prepareStatement(query);
            rs = ps.executeQuery();
    ...
    public List<Product> get4MonitorLast() {
        List<Product> list = new ArrayList<>();
        String query = "select top 4 * from Product\r\n"
                + "where cateID = 4\r\n"
                + "order by id desc";
    ...
    public void refundCart(int productID, int amount) {
        String query1 = "UPDATE [dbo].[Product]\n"
                + "   SET [stock] = ? + [stock]\n"
                + " WHERE id = ?";
        try {
    ...
    public void insertProduct(String name, String image, String price,
            ...
            String model, String manufacturer, String stock, String color, String delivery,
            String image2, String image3, String image4) {
        // Parse the price to an integer, add 100, and convert back to a string
        int priceInt = Integer.parseInt(price);
        priceInt += 100;
        String updatedPrice = String.valueOf(priceInt);

        String query = "insert into Product([name],[image],[price],[title],[description],[cateID],[sell_ID],[model],"
                + "[color],[delivery],[image2],[image3],[image4],[manufacturer],[stock]) "
                + "values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        try {
            ...
            ps.setString(3, updatedPrice); // Use the updated price
            ps.setString(4, title);
            ps.setString(5, description);
            ps.setString(6, category);
            ps.setInt(7, sid);
            ps.setString(8, model);
            ps.setString(9, manufacturer);
            ps.setString(10, stock);
            ps.setString(11, color);
            ps.setString(12, delivery);
            ps.setString(13, image2);
            ps.setString(14, image3);
            ps.setString(15, image4);
    ...
    public void insertAccount2(Account acc) {
        String query = "insert Account([user], pass, isSell, isAdmin, email)\r\n"
                + "values(?,?,?,?,?)";
        try {
            conn = new DBContext().getConnection();//mo ket noi voi sql
...
//            ps.executeUpdate();
    ...
    public void editProduct(String pname, String pimage,
            String pprice, String ptitle,
            String pdescription, String pcategory,
            String pmodel, String pcolor,
            String pdelivery, String pimage2,
            String pimage3, String pimage4,
            String pid, String pmanufacturer, String pstock) {
        ...
        try {
            ...
            ps.setString(13, pmanufacturer);
            ps.setString(14, pstock);
            ps.setString(15, pid);
    ...
    public void editAccount(String isSell, String isAdmin, String uID) {
...
//            ps.executeUpdate();
    ...
    public static void main(String[] args) {
        DAO dao = new DAO();
        System.out.println(dao.getAllReviewByProductID("11"));
//        List<Review> list = 
