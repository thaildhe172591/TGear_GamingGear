 ...
 * @author LDT
 */
public class LoadMoreRazerMouseControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String amount = request.getParameter("exitsRazerM");
        int iamount = Integer.parseInt(amount);
        DAO dao = new DAO();
        List<Product> list = dao.getNext4RazerMProduct(iamount);
        PrintWriter out = response.getWriter();

        for (Product o : list) {
            out.println("<div class=\"productRazerM col-12 col-md-3 col-lg-2\">\r\n"
